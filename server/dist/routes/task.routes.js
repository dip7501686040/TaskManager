...
router.post("/", task_controller_1.default.saveTask);
router.put("/", task_controller_1.default.saveTask);
...
router.get("/getSignedS3URL/:method/:filename", task_controller_1.default.getSignedS3URL);
